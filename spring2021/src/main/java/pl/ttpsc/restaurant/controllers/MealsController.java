...
public class MealsController {
    ...
    public ResponseEntity update(@PathVariable long id, @RequestBody MealEntity meal){
        final MealEntity updatedMeal = mealsService.updateMeal(meal);
